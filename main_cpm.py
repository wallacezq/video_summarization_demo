...
from llm_wrapper import MiniCPMV26Wrapper, Llama32Wrapper
...
if __name__ == '__main__':
    ...
    model_path = args.repo_id_or_model_path if args.repo_id_or_model_path else "openbmb/MiniCPM-V-2_6"
