...
class CustomChatPromptValue(ChatPromptValue):
    ...
    def to_string(self) -> str:
        ...
        print(f"prompt_value: {self.messages}")
...
class CustomChatPromptTemplate(ChatPromptTemplate):
    ...
    # FIXME: can't add tokenizer into constuctor
    # due to error Field required [type=missing, input_value={'messages': [SystemMessa...: {}, 'input_types': {}}, input_type=dict]
    ...
    def invoke(self, input: dict, config: Optional[RunnableConfig] = None) -> CustomChatPromptValue:
        ...
        print(f"formatted_message: {dir(formatted_messages)}")
